...
const addValues = (arr) => {
  // Solution code here...
  let newArr = arr.reduce( (accumulator, num) => {
    return accumulator = accumulator + num;
  }, 0);
  return newArr;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let newArr = arr.reduce( (accumulator, num) => {
    return accumulator = accumulator + num.purchasePrice;
  }, 0);
  return newArr;
};
...
const returnNames = (arr) => {
  // Solution code here...
  let newArr = arr.reduce( (newSWArr, names) => {
    newSWArr.push(names.name);
    return newSWArr;
  }, []);
  return newArr;
};
